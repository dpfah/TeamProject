...
public class MemberImgService {
	  ...
	  @Value("${memberImgLocation}")
	    ...
	    public void updateMemberImg(MemberImg memberImg, Long memberImgId, MultipartFile memberImgFile) throws Exception{
	    	
	    	if(!memberImgFile.isEmpty() && memberImgId > 0){
